    ...
    <body>
        ...
        <div class="splash-screen">
            <div class="splash-content">
                ...
                <div class="text-xl font-bold mb-4">Brian Boler</div>
                <div class="text-sm text-gray-400">Software Engineer & Developer</div>
            </div>
        </div>
        ...
        <script>
            // Add loaded class after a delay to trigger animations
